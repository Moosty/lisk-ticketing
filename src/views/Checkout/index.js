  ...
  return (<div className="mt-10">
    ...
    <div className="pt-10 bg-gray-900 fixed w-full h-screen text-white overflow-y-auto">
      ...
      <div className=" py-5 md:p-12 lg:p-24  h-full flex flex-col ">
        <h1
          className="mx-10 text-4xl leading-10 sm:text-3xl sm:text-center lg:text-5xl text-white font-extrabold">Checkout</h1>
        <div className="p-6 pr-2">
          {/*// TODO vraag aan sander: het lijkt alsof de Sort functie iets kapotmaakt. Weet jij hoe?*/}
          {basket && basket
            .sort((a, b) => {
        ...
        <div className="w-full fixed z-50 p-4 bottom-0 flex flex-row bg-gray-900 justify-between">
          ...
          <Button
            ...
            onClick={() => {
              dispatch(Actions.openModal('confirmTxModal', null))
            }}
