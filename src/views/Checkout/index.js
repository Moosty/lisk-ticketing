...
export const Checkout = withReducer("checkout", reducer)(() => {
    ...
    return (<div>
      <div className="pt-10 bg-gray-900 fixed h-screen text-white overflow-y-auto " style={{maxWidth: '450px', width: '100%'}}>
        <div className="py-5 h-full flex flex-col ">
          ...
          <div className="fixed left-0 z-50 p-4 bottom-0 flex flex-row bg-gray-900 justify-between" style={{maxWidth: '450px', width: '100%'}}>
